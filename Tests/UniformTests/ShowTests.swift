...
struct ShowTests {
	@Test func nameMatchesLegacy() {
		for input in Self.corpus {
			for year in [2001, 2013, 2015, 2018, 2024] {
				for city in [nil, "Syracuse", "Grand Haven", "Chester"] as [String?] {
					#expect(
						Show.name(for: input, in: city, year: year) == Self.legacyName(for: input, in: city, year: year),
						"mismatch for \(input) / \(city ?? "nil") / \(year)"
					)
				}
			}
		}
	...
	@Test func isValidMatchesLegacy() {
		let names: [String?] = [
			nil, "Education Day", "Virtual Show", "Rain Date", "Individual & Ensemble",
			"Performers Showcase", "BIG, LOUD & LIVE", "Big, Loud", "After-Party", "Honors",
			"Street Beat", "Championships – I&E", "Championships - I&E", "DCI World Championship Finals"
		]
		for name in names {
			#expect(Show.isValid(with: name) == Self.legacyIsValid(with: name))
		}
	}

	static let corpus: [String] = [
		"CrownBeat", "DCI Manchester, NH", "DCI Masters", "the Masters of the Summer Music Games",
		"Masters of the Summer Music Games", "DCI Open Finals", "DCI Open Class Finals",
		"DCI World Championships Open Class Championship Finals", "DCI World Championships Open Class Finals",
		"Open Class Finals", "Open Class Championship Finals", "DCI Open Prelims", "DCI Open Class Prelims",
		"DCI World Championships Open Class Championship Prelims", "Open Class Semifinals",
		"DCI World Championships Open Class Semifinals", "World Class Quarterfinals",
		"DCI World Championships World Class Quarterfinals", "DCI World Championships – Div I Quarterfinals",
		"DCI World Championships – Div I Quarter Finals", "DCI Championships – Div I Quarterfinals",
		"DCI Championships – Div I Quarter Finals", "Open Class Quarterfinals",
		"DCI World Championships Open Class Quarterfinals", "DCI Finals", "DCI World Class Finals",
		"DCI World Championships World Class Finals", "World Class Finals", "DCI World Championships – Div I Finals",
		"DCI Championships – Div I Finals", "DCI Championships – DCI I Finals", "DCI Prelims", "DCI World Class Prelims",
		"DCI Semifinals", "DCI World Class Semi-Finals", "World Class Semi-Finals", "World Class Semifinals",
		"DCI World Championships World Class Semifinals", "DCI World Championships – Div I Semifinals",
		"DCI World Championships – Div I Semi Finals", "DCI Championships – Div I Semifinals",
		"DCI Championships – Div I Semi-Finals", "DCI World Championships – II/III Prelims",
		"DCI Championships – Div II/III Prelims", "DCI World Championships – II/III Division Finals",
		"DCI Championships – Div II/III Semifinals", "DCI World Championships – II/III Grand Finals",
		"DCI Championships – Div II/III Finals", "DCA Open Class & Class A Prelims", "DCA Class A & Open Class Finals",
		"DCI Southeastern", "DCI Atlanta Southeastern Championship", "DCI Southwestern", "DCI Sioux City",
		"Music in Motion – Maryland", "Music in Motion-Maryland", "Music in Motion-Pennsylvania",
		"Music in Motion-New Jersey", "Music in Motion – New Jersey", "Music in Motion – Central Jersey",
		"Music is Cool–The New Jersey Edition", "Music is Cool–The Tri-state Giants Stadium Edition",
		"Music is Cool – The New Jersey Edition", "Music is Cool – The Tri-state Giants Stadium Edition",
		"Music City Metal III – the Southern Drumdown", "Music on the March 2", "THUNDER in the DESERT",
		"TIDEWATER Summer Music Games", "THE exSIGHTment OF SOUND", "Festival of Brass Drum",
		"DCA World Championships – Prelims", "DCA Prelims", "DCA Championship Prelims", "DCA Open Class Prelims",
		"DCA Open Class Preliminary", "DCA Class A Prelims", "DCA Class A Preliminary", "DCA World Championships – Finals",
		"DCA Finals", "Finals", "DCA Championship Finals", "DCA Class A & Open Class Championships",
		"Drum Corps United Kingdom Open Prelims", "Drum Corps United Kingdom Finals", "British Drum Corps Championships",
		"Drum Corps Europe Championships Prelims", "Drum Corps Europe Championships Finals", "Drum Corps Europe Championships",
		"DCE Championships", "Mini-Corps/I&E", "Mini-Corps Championships", "I&E and Mini-Corps",
		"Mini-corps Championships & I&E", "DCA I&E – Mini-Corps", "Mini-Corps Competition", "DCA Alumni Spectacular",
		"Alumni Spectacular", "Drum Corps in Northern Virginia", "Drums Across the Columbia", "Drums Along The Mississippi",
		"Drums at the Rose Bowl", "Gold Showcase (Drum Corps at the Glen)", "March On", "Nightbeat", "NightBeat",
		"Summer Music Games of Southern Virginia", "Tour Premiere", "Drum Corps: An American Tradition – Metro",
		"Diablo Valley Classic Pacific Open Class Championship Finals", "The Everett Drum & Bugle",
		"GLASSMEN All-Star Review", "All Star Review", "Drums Across Garden", "Phantom Regiment’s Show of Shows",
		"DCI West Championship", "Kiltie Klassic", "Allstate Starlite Drum-O-Rama", "Drum Corps – An American Tradition",
		"OST Type keywords..Drum Corps: An American Tradition’DCA Edition",
		"Southwest Corps Connection – A Night of Drum Cprps Champions", "The Dayton Summer Classic",
		"The Blue Cross Blue Shield of Arizona – DCI Desert Classic", "RUMBLE in the DESERT", "SPIRIT of America",
		"SUMMER THUNDER", "DCI World Championships Finals", "DCI World Championships – Division I Finals",
		"World Championships Finals", "DCI World Championships", "DCI World Championships Quarterfinals",
		"DCI World Championships – Division I Quarter Finals", "World Championships Quarterfinals",
		"DCI World Championships Quarter Finals", "DCI World Championships Semifinals",
		"DCI World Championships – Division I Semi Finals", "World Championships Semifinals",
		"DCI World Championships Semi Finals", "World Championship Prelims", "Open Class & Class A Prelims",
		"DCA Open Class World Championship Prelims", "DCA Championships and Class A Prelims",
		"DCA Championships Open Class Prelims", "Open Class & Class A Finals", "DCA Championships – Open Class Finals",
		"DCI World Championships Div II & III Finals", "DCI World Championships – Division II & III Finals",
		"World Championships – Division II & III Finals", "DCI World Championships Division II/III Finals",
		"DCI World Championships Division II & III Prelims", "DCI World Championships – Division II & III Prelims",
		"World Championships – Division II & III Prelims", "DCI World Championships Division II & III Semifinals",
		"World Championships – Division II & III Semifinals", "DCI World Championships – Division II Semi Finals",
		"DCI World Championships – Division III Semi Finals", "DCI Championships – Div II Prelims",
		"DCI World Championships Division II Prelims", "DCI Championships – Div III Prelims",
		"DCI World Championships Division III Prelims", "The DCI Division II & III Championship Preview",
		"DCI Atlanta – the Southeastern Championships – Afternoon", "DCI Atlanta – the Southeastern Championship – Afternoon",
		"DCI Atlanta – the Southeastern Championships – Evening", "DCI Atlanta – the Southeastern Championship – Evening",
		"DCI San Antonio – the Southwestern Championship – Afternoon", "Southwestern Championships– Afternoon",
		"DCI Southwestern Afternoon", "DCI San Antonio – the Southwestern Championship – Evening",
		"Southwestern Championships-Evening", "Southwestern Championships-Evening Show", "Southwestern Championships – Evening",
		"Southwestern Championships– Evening", "DCI San Antonio – the Southwestern Championship – Morning Show",
		"Southwestern Championships-Morning Show", "Southwestern Championships-Morning", "Southwestern Championships – Morning",
		"DCI Midwestern Championship", "Midwestern Championships, Night Show", "The Midwestern Championships, Night Show",
		"The Midwestern Championships, Day Show", "Midwestern Championships, Day Show", "Midwestern Championships – 1:00PM Event",
		"DCI Midwestern – Noon Show", "Midwestern Championships – 7:30PM Event", "DCI Midwestern Evening",
		"A Summer Extravaganza of Outdoor Pageantry-EXHIBITION",
		"DCI Indianapolis – the Central Division Championships – Afternoon",
		"DCI Indianapolis – the Central Division Championships – Evening", "Canadian Open -Prelims",
		"DCM – Division I and Division II Prelims", "DCM Championships – Division I & II Prelims",
		"DCM Championships – Division III Prelims", "DCM Championships – Senior Prelims",
		"DCM Championships – Division III & Senior Prelims", "DCA Championships Class A Finals",
		"Garden State Circuit Championship", "Drum Corps Japan Championship", "Corps at the Crest Los Angeles",
		"SoCal Classic: Open Class Pacific Championship Finals", "US Coast Guard Open Finals", "US Coast Guard Open Prelims",
		"DCUK Contest Leicester", "DMG Contest Huizen",
		"31st Annual Moonlight Classic 2015", "DCI Southwestern Championship",
		"Barnum Festival Champions on Parade", "Drum Along the Waterfront", "So Cal Classic",
		"Name TBD", "DCA Championships", "Prelims", "Drum Corps: An American Tradition",
		"Drums Across America", "Some Random Show Name", "Cavalcade of Brass"
	]

	private static func legacyName(for record: String, in city: String?, year: Int) -> String {
		...
		let nameReplacements = [
			("- ", "– "), ("--", "–"), ("?", "–"), ("'", "’"), ("… ", "’"), ("  ", " "), (" Corps Show", ""),
			("&amp;", "&"), ("@ the Glen", "at the Glen"), ("WDBJ-7 ", ""), (" Drum Corps Competition", ""),
			(" Drum Corps Competion", ""), (" Drum Corps Comp", ""), (". Drum", "Drum"),
			("Barnum Festival Champions", "Barnum Festival: Champions"), ("Innovations in Brass:", "Innovations in Brass –"),
			("Tour of Champions:", "Tour of Champions –"), ("Brigadiers", "Brigadier’s"), ("Brigadier’s’", "Brigadier’s"),
			("Drum Along", "Drums Along"), ("Champions,", "Champions"), ("Crest San,", "Crest – San"),
			("Crest Los,", "Crest – Los"), ("Crest Walnut,", "Crest – Walnut"), ("Games Portland", "Games – Portland"),
			("Games Seattle", "Games – Seattle"), ("Shows Waukesha", "Shows – Waukesha"), ("Jerset", "Jersey"),
			("Lousiana", "Louisiana"), ("LaCrosse", "La Crosse"), ("Masters Summer", "Masters of the Summer"),
			("Rhapsody-Metamora", "Rhapsody – Metamora"), ("Rhapsody-La Crosse", "Rhapsody – La Crosse"),
			("Mid-Cal", "MidCal"), ("Northwest Music Games", "Northwest Youth Music Games"), ("Mini Corps", "Mini-Corps"),
			("So Cal", "SoCal"), ("So-Cal", "SoCal"), ("Southeastern Regional", "Southeastern Championship"),
			("Southwestern Regional", "Southwestern Championship"), ("SUMMER MUSIC GAMES", "Summer Music Games"),
			("MUSIC GAMES", "Music Games"), ("NATIONALS", "Nationals"), ("Tradition–", "Tradition –"),
			("Tradition, ", "Tradition – "), ("Texas,", "Texas"), ("Mississippi River,", "Mississippi"),
			("Love, Drum", "Love, and Drum"), ("The Marching Millionaires", "Marching Millionaires"),
			("The DCI South", "DCI South"), ("The Kiltie Klassic", "Kiltie Klassic"), (", the 2014 DCI Tour Premiere", ""),
			(", a Tour of Champions Series event", ""), (" – A DCI/DCA split event!", ""), (" – A DCI Northwest Classic", ""),
			("OST Type keywords’ ", ""), ("Afternoon Show", "Afternoon"), ("Afternoon show", "Afternoon"),
			("Evening Show", "Evening"), ("Evening show", "Evening"), ("Preliminaries", "Prelims"),
			("Calvacade", "Cavalcade"), ("--RAINED OUT", ""), ("–RAINED OUT", ""), ("-RAINED OUT", ""), ("RAINED OUT", ""),
			("Starliet", "Starlite"), ("Clasic", "Classic"), ("Californa", "California"), ("Kingson", "Kingston"),
			("Individiual", "Individual"), ("CORNHUSKER", "Cornhusker"), ("Rockies -–", "Rockies –"),
			("Rockies-", "Rockies – "), ("The Summer Music Games", "Summer Music Games")
		]
	...
	private static func legacyIsValid(with name: String?) -> Bool {
