...
public extension Show {
	static func name(for record: String, in city: String?, year: Int) -> String {
		...
		case "DCA World Championships – Prelims": "DCA World Championship Prelims"
		case "DCA World Championships – Finals": "DCA World Championship Finals"
		case "Mini-Corps Championships": "DCA World Championships – Mini-Corps & I&E"
