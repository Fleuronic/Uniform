...
public extension Show {
	...
	static func scoreSlug(for slug: String, in city: String?, year: Int) -> String {
		...
		case ("dci-open-class-world-championships-prelims", 2013): "dci-world-championships-open-class-championship-prelims"
		case ("dci-open-class-world-championships-finals", 2013): "dci-championships-open-class-championship-finals"
